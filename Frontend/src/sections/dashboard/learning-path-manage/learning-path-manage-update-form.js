...
import { LearningPathUpdateCourse } from './learning-path-update-course';
...
export const LearningPathUpdateForm = ({typeLearnerId, typeLearnerName, typeLearnerStartScore}) => {
  ...
  // const [sequenceCourse, setSequenceCourse] = useState([]);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      try {
        ...
        const localStorageData = localStorage.getItem("updateSequenceCourseIds");
  ...
  //   try {
  //     const response = await learningPathApi.getSequenceCouresByLearnerId({"typeLearnerId":typeLearnerId});
  
  //     if (isMounted()) {
  //       const fetchedCourseIds = response.data.courses;
  //       initialValues = {
  //         group_name: response.data.courses.typeLearnerName,
  //         score : 0,
  //         courseIds: [],
  //       };
          ...
          <CardContent>
            ...
            >
              ...
              <Grid
                ...
                md={8}
              >
                <LearningPathUpdateCourse typeLearnerId={typeLearnerId}/>
              </Grid>
            </Grid>
          </CardContent>
        </Card>
