...
import { CourseUpdateForm } from '../../../../sections/dashboard/learning-path-manage/course-update-form';
...
const LearningPathCreate = ({typeLearnerId}) => {
            ...
            <Stack spacing={1}>
              ...
              <Breadcrumbs separator={<BreadcrumbsSeparator />}>
                ...
                <Link
                  color="text.primary"
                  component={NextLink}
                  href={`${paths.dashboard.learning_path_manage}/updated/${typeLearnerId}`}
                  variant="subtitle2"   
                >
